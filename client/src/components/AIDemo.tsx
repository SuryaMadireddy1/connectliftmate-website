    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center transition-opacity">
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="mb-2">Enter a job title or profile description to generate a personalized connection message using AI.</p>
          <p className="mb-6 text-sm text-primary-700 dark:text-primary-400 font-medium bg-primary-50 dark:bg-primary-900/30 p-2 rounded-md">
            <span className="mr-1">🔑</span> Requires your own Groq API key in the settings
          </p>
          <div className="flex flex-col space-y-4">
            <div className="flex items-center space-x-2">
              ...
              />
              <button className="bg-gray-100 dark:bg-gray-800 p-2 rounded border border-gray-300 dark:border-gray-700 hover:bg-gray-200 dark:hover:bg-gray-700" title="API Settings">
